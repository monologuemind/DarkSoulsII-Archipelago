...
std::map<uint32_t, DS2SpEffectRequest> special_effects = {
    ...
    {90000600, {"Slight Corrosion", 2, {create_effect(120000310, 25, 2), create_effect(140001000, 25, 2), create_effect(140001010, 25, 2)}}}, // Corrosion effects with the -7 durability in the middle
    {90000700, {"Medium Corrosion", 5, {create_effect(120000310, 25, 2), create_effect(140001000, 25, 2), create_effect(140001010, 25, 2)}}}, // Corrosion effects with the -7 durability in the middle
    {90000800, {"Heavy Corrosion", 8, {create_effect(120000310, 25, 2), create_effect(140001000, 25, 2), create_effect(140001010, 25, 2)}}}, // Corrosion effects with the -7 durability in the middle
